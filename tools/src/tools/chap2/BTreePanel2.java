...
public class BTreePanel2 extends JPanel {
	static final int DATA_WIDTH = 80, LINK_WIDTH = 2, NODE_HEIGHT = 40, X_MARGIN = 3, LAYER_HEIGHT = 60;
	...
	static void drawNode(Graphics2D g, MyNode node, int x0, int y0) {
		...
		for (int i = 0; i < node.count; ++i) {
			...
			drawCenteredString(g, String.valueOf(node.sData[i]), r);
		}
